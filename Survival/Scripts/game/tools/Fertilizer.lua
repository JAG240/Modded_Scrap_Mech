...
function Fertilizer.onUse( self )
	...
	sm.effect.playHostedEffect("Itemtool - FertilizerUse", self.tool:getOwner():getCharacter(), "jnt_right_hand" )
end
	...
	if params.targetSoil then
		if sm.container.beginTransaction() then
			...
			if sm.container.endTransaction() then
				sm.event.sendToHarvestable( params.targetSoil, "sv_e_fertilize" )
