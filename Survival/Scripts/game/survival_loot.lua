...
local random_loot = {
	...
	{ uuid = obj_plantables_banana, 		chance = 5,	quantity = 1 },
	{ uuid = obj_plantables_blueberry, 		chance = 5,	quantity = 1 },
	{ uuid = obj_plantables_orange, 		chance = 5,	quantity = 1 },
	{ uuid = obj_plantables_potato, 		chance = 5,	quantity = randomStackAmountAvg5 },
	{ uuid = obj_consumable_sunshake, 		chance = 5 },
	{ uuid = obj_consumable_gas,			chance = 3,	quantity = randomStackAmountAvg5 },
	{ uuid = obj_consumable_chemical,		chance = 10,	quantity = randomStackAmount5 },
	{ uuid = obj_consumable_component,		chance = 20,	quantity = 1 },
	{ uuid = obj_consumable_soilbag,		chance = 10,	quantity = 1 },
	{ uuid = obj_resource_circuitboard,		chance = 20 },
	{ uuid = obj_seed_carrot,				chance = 2,	quantity = randomStackAmountAvg2 },
	{ uuid = obj_seed_redbeet,				chance = 2,	quantity = randomStackAmountAvg2 },
	{ uuid = obj_seed_tomato,				chance = 2,	quantity = randomStackAmountAvg2 },
	{ uuid = obj_seed_potato,				chance = 2,	quantity = randomStackAmountAvg2 },
	{ uuid = blk_glass,						chance = 2,	quantity = randomStackAmount10 },
	{ uuid = jnt_bearing, 					chance = 2,		quantity = 1 },
}
...
local random_warehouseloot = {
	...
	{ uuid = obj_resource_circuitboard,		chance = 60 },
	...
	{ uuid = obj_consumable_component,		chance = 60,	quantity = 1 },
}

local random_loot_startarea = {
	{ uuid = obj_scrap_smallwheel,			chance = 20 },
	...
	{ uuid = obj_consumable_soilbag,		chance = 25,	quantity = 3 },
	{ uuid = obj_plantables_carrot,			chance = 25,	quantity = 3 },
	{ uuid = obj_plantables_redbeet,		chance = 25,	quantity = 3 },
	{ uuid = obj_plantables_tomato,			chance = 25,	quantity = 3 },
	{ uuid = obj_seed_carrot,				chance = 5,	quantity = randomStackAmountAvg2 },
	{ uuid = obj_seed_redbeet,				chance = 5,	quantity = randomStackAmountAvg2 },
	{ uuid = obj_seed_tomato,				chance = 5,	quantity = randomStackAmountAvg2 },
...
local loot_woc = {
	...
	randomLoot = {
	{ uuid = obj_resource_steak,				chance = 5 },
	}
}
...
local loot_woc_milk = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_consumable_milk,			chance = 5 },
	}
}
...
local loot_glow_goop = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_resource_glowpoop,			chance = 5 },
	}
}
...
local loot_totebot_green = {
	...
	randomLoot = {
        ...
        { uuid = obj_consumable_component,		chance = 50 },
	}
}
...
local loot_tapebot = {
	...
	randomLoot = {
		{ uuid = obj_consumable_component,		chance = 50 },
		{ uuid = obj_consumable_battery,		chance = 50 },
	}
}
...
local loot_farmbot = {
	...
	selectOne = {
		{ uuid = obj_survivalobject_keycard,	chance = 10 },
	},
	randomLoot = {
