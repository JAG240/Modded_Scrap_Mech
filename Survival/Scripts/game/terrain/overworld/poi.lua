...
function initPoiTiles()
	...
	g_poiTiles[POI_AUTUMNFOREST_RUIN] = {
		addPoiTile( POI_AUTUMNFOREST_RUIN, 1, "$SURVIVAL_DATA/Terrain/Tiles/poi/Ruin_Meadow_64_01.tile" ), --TODO: Autumn forest ruin
	}
	g_poiTiles[POI_AUTUMNFOREST_RANDOM] = {
		addPoiTile( POI_AUTUMNFOREST_RANDOM, 1, "$SURVIVAL_DATA/Terrain/Tiles/poi/Ruin_Meadow_64_01.tile" ), --TODO: Autumn forest ruin
